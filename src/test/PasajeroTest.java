...
public class PasajeroTest extends TestCase {
		...
		private Pasajero pasajero2 = new Pasajero("1255","pap@loj.com");
		...
		protected void setUp() throws Exception {
			...
			sistema.registrarUsuario(unPasajero); sistema.registrarUsuario(pasajero2); 
			sistema.registrarHotel(hotel1);sistema.registrarHotel(hotel2);sistema.registrarHotel(hotel3);
			sistema.registrarReserva(reservaActual); sistema.registrarReserva(reservaAntigua);
			sistema.registrarReserva(reservaFutura); sistema.registrarReserva(reservaFuturaEnNDias); 
		}
		...
		public void test02_DadoUnPasajeroYUnaListaDeReservasObtengoTodasLasReservasFuturas() {
			Collection<Reserva> listaObtenida = unPasajero.reservasFuturas(sistema.getReservasDelUsuario(unPasajero));
		...
		public void test03_DadoUnPasajeroYUnaListaDeReservasObtengoTodasLasReservasQueFueronRealizadasParaUnaCiudadParticular() {
			Collection<Reserva> listaObtenida = unPasajero.reservasEnUnaCiudadParticular(sistema.getReservasDelUsuario(unPasajero), "CABA");
		...
		public void test04_DadoUnPasajeroYUnaListaDeReservasObtengoTodasCiudadesDondeSeRealizarionReservas() {
			Collection<String> listaObtenida = unPasajero.ciudadesDondeSeRealizaronReservas(sistema.getReservasDelUsuario(unPasajero));
		...
		public void testGetReservasDelUsuario(){
			Collection<Reserva> listaObtenida = unPasajero.getReservas(sistema); 
